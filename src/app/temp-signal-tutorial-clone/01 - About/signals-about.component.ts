...
@Component({
    ...
    template: `
        <h2>About Signals</h2>
        <p>
            Signals are one of the most powerful ways to manage component state
            in all of Angular. You can synchronously derive state from other
            state in an efficient way that is much easier to read than RXJS.
            Though they do not replace RXJS. In fact, they can be best friends.
        </p>
        <p>
        ...
        <p>
            What you see below and is explained in the following two paragraphs
            is typically done step by step.
        </p>
        <ul>
        ...
        <p>
            But the magic of signals is in the last two pieces, deriving values
            and doing side effects. Because you can initialize and change data
            in many more ways than signals. The derived values and side effects,
            and how easily it can be done, is the real end goal of signals. So
            some basics of all of this is right here, and after a few examples
            like this it will go step by step from the start.
        </p>
        <p>
            In the following example, a form field for setting a name and a
            dropdown for setting a title both set signal values. There is also
            buttons to change the name, and each one changes the signal directly
            in one of two ways. And in between, you can see the value of not
            just either signal, but also a signal which is a value which is
            computed from either value.
        </p>
        <div id="form-and-signals">
            ...
            <div>
                <p>
                    Signal values are accessed like methods, using
                    <code>()</code>.
                </p>
...
$nameAndTitle(): {{
            ...
            <button (click)="uppercaseName()">
                Name to uppercase (signal set)
            </button>
        ...
        <p>
            Check the console. A signal <code>effect</code> (ie for side effects
            of a signal value changing) logs anytime a signal value changes.
        </p>
    `,
    styles: `
        #form-and-signals {

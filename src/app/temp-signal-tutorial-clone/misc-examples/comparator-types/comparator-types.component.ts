...
@Component({
    ...
    template: `
        <div class="example">
            ...
            <p>
                Hand rolled utility to sync up to reactive form value, status,
            ...
            <form [formGroup]="form">
                <div id="form">
                        ...
                        <mat-select formControlName="dataType">
                            @for (type of types; track $index) {
                                <mat-option
                                    [value]="type"
                                    (click)="
                                        form.controls.comparator.setValue('');
                                        form.controls.value.setValue('')
                                    "
                                    >{{ type }}</mat-option
                                >
                            }
                    ...
                    @switch ($comparator()) {
                        ...
                        @case (
                            $comparator() === 'Contains' ||
                            $comparator() === 'Equals (case sensitive)' ||
...
export class ComparatorTypesComponent {
    ...
    form = new FormGroup({
        dataType: new FormControl<'number' | 'date' | 'varchar' | undefined>(
            undefined,
        ),
        comparator: new FormControl<
            ...
            | ''
        >(''),
        value: new FormControl<Date | string | number | undefined>(
            undefined,
            Validators.required,
        ),
    });
